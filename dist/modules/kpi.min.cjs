/*!
 * Lattice Grid 1.55.0, kpi module
...
return`${this.#queryVersion}|${querySignature({filters:this.#state('filters',null),quick:this.#state('quick',''),quickMode:this.#state('quickMode','contains')})}|${hostActive}`;
}
...
if(!filters&&!quick&&!hostActive)return base;
let mask=null;
if(filters){
...
if(hostActive&&!host.passes(this.#leafRow(physical)))continue;
out[n++]=physical;
}
if(mask){
