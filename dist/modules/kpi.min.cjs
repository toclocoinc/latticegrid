/*!
 * Lattice Grid 1.54.0, kpi module
...
const __m4=__req("packages/modules/kpi/tree.js");
const resolveHierarchy=__m4["resolveHierarchy"];
const decorateNodes=__m4["decorateNodes"];
const branchKeys=__m4["branchKeys"];
const visibleNodes=__m4["visibleNodes"];
const __m5=__req("packages/modules/kpi/messages.js");
const resolveMessages=__m5["resolveMessages"];
...
'rows.apply on a grid-bound KPI panel is ignored; route to the bound grid instead.');
return;
}
...
kpi.refresh=()=>{seed();return refreshModel();};
