/*!
 * Lattice Grid 1.50.0, tabs module
...
style.textContent=`
.${NS}{display:flex;flex-direction:column;height:100%;font:inherit}
.${NS}__list{display:flex;flex-wrap:wrap;gap:2px;border-bottom:1px solid var(--${NS}-border,#d7dbe0);padding:0 2px;flex:0 0 auto}
.${NS}__tab{font:inherit;appearance:none;border:1px solid transparent;border-bottom:none;background:transparent;
  padding:.5em .9em;border-radius:6px 6px 0 0;cursor:pointer;color:var(--${NS}-muted,#586069)}
.${NS}__tab:hover{background:var(--${NS}-hover,#f1f3f5)}
.${NS}__tab:focus-visible{outline:2px solid var(--${NS}-focus,#2563eb);outline-offset:-2px}
.${NS}__tab[aria-selected="true"]{background:var(--${NS}-bg,#fff);border-color:var(--${NS}-border,#d7dbe0);
  color:var(--${NS}-active,#14171a);font-weight:600}
