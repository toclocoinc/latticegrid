/*!
 * Lattice Grid 1.69.0, charts module
...
const CARTESIAN=__m0["CARTESIAN"];
...
margin:this.#spec.margin,
titleSize:typography.axisTitle,
titles:(CARTESIAN[type]&&CARTESIAN[type].horizontal)
?{left:axis.x.title,bottom:axis.y.title,right:axis.y2.title}
:{left:axis.y.title,bottom:axis.x.title,right:axis.y2.title},
