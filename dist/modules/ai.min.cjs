...
'comments.edited':'{time} (edited)',
'comments.cellTitle':'{column}: {row}',
...
'presence.peer':'{name}: jump to their cursor',
'presence.peerIdle':'{name}, idle: jump to their cursor',
'presence.peerHidden':'{name}, not in the current view',
