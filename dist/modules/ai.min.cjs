...
const __m5=__req("packages/modules/ai/view.js");
const Emitter=__m5["Emitter"];
const mountPanel=__m5["mountPanel"];
const paintPanel=__m5["paintPanel"];
const explainButton=__m5["explainButton"];
const documentFor=__m5["documentFor"];
const mountAskBar=__m5["mountAskBar"];
const paintAskBar=__m5["paintAskBar"];
const AI_EVENTS=Object.freeze(['narrative','query','error']);
