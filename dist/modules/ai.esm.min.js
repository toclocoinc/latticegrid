...
const __m4=__req("packages/modules/ai/view.js");
const Emitter=__m4["Emitter"];
const mountPanel=__m4["mountPanel"];
const paintPanel=__m4["paintPanel"];
const explainButton=__m4["explainButton"];
const documentFor=__m4["documentFor"];
const AI_EVENTS=Object.freeze(['narrative','error']);
