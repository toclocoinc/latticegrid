/*!
 * Lattice Grid 1.16.0, react module
...
'stream:chunk','stream:end','stream:evicted','cell:changed','cell:pending',
'cell:confirmed','cell:reverted','cell:clicked','cell:dblclicked','cell:contextmenu',
'cell:edit:start','cell:edit:end','row:edit:start','row:edit:end','row:clicked',
'row:dblclicked','form:opened','form:closed','form:saved','form:error',
...
'column:menu:open','columns:changed','columns:tagged','header:contextmenu',
...
throw new TypeError('createLatticeGrid needs React: createLatticeGrid({ React, createGrid }).');
}
if(typeof createGrid!=='function'){
throw new TypeError('createLatticeGrid needs createGrid: createLatticeGrid({ React, createGrid }).');
}
const{createElement,useRef,useEffect,useImperativeHandle,forwardRef}=React;
const split=(props)=>{
const host={};
const grid={};
for(const[key,value]of Object.entries(props||{})){
...
createGrid,
element,
props:split(propsRef.current).grid,
});
