/*!
 * Lattice Grid 1.68.0, tabs module
...
style.textContent=`
:where(.${NS}){display:flex;flex-direction:column;height:100%;
...
:where(.${NS} .${NS}__tab:focus-visible){outline:2px solid var(--${NS}-focus,#2563eb);outline-offset:var(--${NS}-focus-offset,-4px)}
...
:where(.${NS} .${NS}__icon){flex:none;display:inline-flex;align-items:center;justify-content:center;line-height:1}
:where(.${NS} .${NS}__label){min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
...
:where(.${NS}__unit){position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap}
:where(.${NS}__panels){position:relative;flex:1 1 auto;min-height:0}
:where(.${NS}__panel){position:absolute;inset:0}
:where(.${NS}__panel[hidden]){display:none}
:where(.${NS}__body){position:absolute;inset:0}
:where(.${NS}__live){position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap}
`;
