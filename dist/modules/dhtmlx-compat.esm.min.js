/*!
 * Lattice Grid 1.16.0, dhtmlx-compat module
...
const __m0=__req("packages/core/src/internal/util.js");
const warnOnce=__m0["warnOnce"];
const __m1=__req("packages/modules/dhtmlx-compat/util.js");
const reportUntranslated=__m1["reportUntranslated"];
...
if(htmlEnable)el.innerHTML=String(out);
...
const __m6=__req("packages/modules/dhtmlx-compat/util.js");
const rowsFrom=__m6["rowsFrom"];
const reportUntranslated=__m6["reportUntranslated"];
