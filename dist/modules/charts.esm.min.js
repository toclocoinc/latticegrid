/*!
 * Lattice Grid 1.8.0 — charts module
...
const NS=__m5["NS"];
const __m6=__req("packages/modules/charts/scheme.js");
const rampStops=__m6["rampStops"];
const resolveScheme=__m6["resolveScheme"];
const __m7=__req("packages/modules/charts/labels.js");
const drawAnchoredLabels=__m7["drawAnchoredLabels"];
const labelText=__m7["labelText"];
...
const DISTRIBUTION=new Set(['histogram','boxplot']);
...
this.#drawn=type==='histogram'
?drawHistogram({...shared,buckets:this.#spec.buckets})
:drawBoxPlot(shared);
this.#drawLegend([]);
}else{
