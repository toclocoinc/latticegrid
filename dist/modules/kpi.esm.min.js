/*!
 * Lattice Grid 1.45.0, kpi module
...
fig.setAttribute('aria-label',`${t.label}: ${t.formatted}${t.status?`, ${t.status}`:''}`);
...
const status=bandFor(value,t.spec);
let delta=null;
