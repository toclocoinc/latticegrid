/*!
 * Lattice Grid 1.63.0, kpi module
...
return`${this.#queryVersion}|${querySignature({filters:this.#state('filters',null),quick:this.#state('quick',''),quickMode:this.#state('quickMode','contains')})}|${hostActive}|${whereVersion}`;
}
