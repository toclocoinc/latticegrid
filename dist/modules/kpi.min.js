/*!
 * Lattice Grid 1.58.0, kpi module
...
const counted=/^last(\d*)days?$/.exec(flat);
if(counted){
const n=counted[1]?Number(counted[1]):Number(fallbackN);
...
`Known tokens: ${RELATIVE_TOKENS.join(', ')}.`,
);
return condition;
}
return{
